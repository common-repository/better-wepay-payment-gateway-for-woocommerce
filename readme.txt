...
== Description ==
**Better WePay Payment Gateway for WooCommerce** is a payment gateway that allows your WooCommerce powered store / e-commerce website to accept credit card and bank payment via WePay.
...
### Contribution
Plugin is open source on [GitHub](https://github.com/OmnipayWP/wepay-for-woocommerce). Issues and pull requests are welcome.
